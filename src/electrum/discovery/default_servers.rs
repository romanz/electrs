...
pub fn add_default_servers(discovery: &DiscoveryManager, network: Network) {
    match network {
        Network::Bitcoin => {
            ...
            discovery.add_default_server("electrum.mindspot.org".into(), vec![Service::Ssl(50002)]);
            discovery.add_default_server(
                "electrum.qtornado.com".into(),
                vec![Service::Tcp(50001), Service::Ssl(50002)],
            );
            discovery.add_default_server("electrum.taborsky.cz".into(), vec![Service::Ssl(50002)]);
            discovery.add_default_server(
            ...
            discovery.add_default_server("electrumx.ftp.sh".into(), vec![Service::Ssl(50002)]);
            discovery.add_default_server(
                "electrumx.ml".into(),
                vec![Service::Tcp(50001), Service::Ssl(50002)],
            );
            ...
            discovery.add_default_server("rbx.curalle.ovh".into(), vec![Service::Ssl(50002)]);
            discovery
            ...
            discovery.add_default_server("technetium.network".into(), vec![Service::Ssl(50002)]);
            discovery.add_default_server(
            ...
            discovery.add_default_server("btc.usebsv.com".into(), vec![Service::Ssl(50006)]);
            discovery.add_default_server(
                "e2.keff.org".into(),
                vec![Service::Tcp(50001), Service::Ssl(50002)],
            );
            discovery.add_default_server("electrum.hodlister.co".into(), vec![Service::Ssl(50002)]);
            discovery
